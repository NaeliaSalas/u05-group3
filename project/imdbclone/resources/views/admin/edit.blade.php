            ...
            <form action="{{ route('admin.update', ['id'=>$users->id]) }}" method="POST">
                ...
                <div class="input-fields">
                    <div class="form-input-material">
                        ...
                        <input class="input" type="text" name="name" value="{{ $users->name}}"><br>
                    </div>

                    <div class="form-input-material">
                        <label for="username">Username</label>
                        <input class="input" type="text" name="username" value="{{ $users->username }}"><br>
                    </div>

                    <div class="form-input-material">
                        <label for="email">Email</label>
                        <input class="input" type="email" name="email" value="{{ $users->email }}"><br>
                    </div>
                </div>
